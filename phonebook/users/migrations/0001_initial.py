    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('local_number', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.voipnumber', unique=True, verbose_name='Локальный номер')),
            ],
            options={
                'verbose_name': 'user',
